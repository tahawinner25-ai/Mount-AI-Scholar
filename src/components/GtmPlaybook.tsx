...
export default function GtmPlaybook({ user, mlEngineUrl }: GtmPlaybookProps) {
  ...
  const handleGeneratePost = async () => {
    ...
    if (isHn) {
      ...
      prompt = `Tu es un vainqueur de hackathons mondiaux d'élite de Google DeepMind et de Google Cloud.
      ...
      1. Structure avec des titres très clairs : 
         ...
         - **How we built it**: Présente l'architecture technique (React/Vite, OpenAI Codex local inference, Express / Codex API, Google Gemini API pour la synthèse cognitive). Montre la prouesse de l'inférence locale "Privacy by Design".
         ...
         - **What's next for ${prodName}**: La roadmap d'acquisition par Google et le scale mondial.
