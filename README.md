...
* **100% Local Processing:** The Presentation and Simplification Engine (`ml_engine_prototype.py`) runs Gemma 4 entirely locally.
* **Privacy by Design:** By using Gemma 4 locally via Python, no biometric or cognitive data ever leaves the student's workstation.
* **Optimized for Neurodiversity:** Gemma 4 is instruction-tuned to break down complex texts into phoneme-friendly, dyslexia-adapted summaries without latency spikes.
